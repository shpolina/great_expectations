...
class ExpectColumnMostCommonValueCountToBeBetween(ColumnExpectation):
    """Expect the most common value to be within the designated value set

            expect_column_most_common_value_count_to_be_between is a \
    ...
    metric_dependencies = ("column.most_common_value_count",)
    ...
    def _prescriptive_renderer(
        ...
        **kwargs,
        ...
        if (params["min_value"] is None) and (params["max_value"] is None):
            template_str = "Count of most common value may have any numerical value."
        else:
            at_least_str, at_most_str = handle_strict_min_max(params)

            if params["min_value"] is not None and params["max_value"] is not None:
                template_str = f"Count of most common value must be {at_least_str} $min_value and {at_most_str} $max_value."
            elif params["min_value"] is None:
                template_str = f"Count of most common value must be {at_most_str} $max_value."
            elif params["max_value"] is None:
                template_str = f"Count of most common value must be {at_least_str} $min_value."
